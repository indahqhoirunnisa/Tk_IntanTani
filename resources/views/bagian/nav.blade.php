...
<nav class="bg-[#AA8B56]">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-8 py-2.5">
        <a href="/" class="flex items-center">
            <span class="self-center text-3xl font-semibold whitespace-nowrap text-[#F0EBCE]">E-FaGro Intan Tani</span>
        </a>
        
        @guest
        <div class="flex items-left">
          <a href="/login"  class="text-white font-semibold text-sm px-5 py-2.5 text-center mr-2 mb-2">Login</a>
          <a href="/register" class="text-white bg-[#DFD3C3]  font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Register</a>
        </div>
        @endguest
        @auth
        <div class="flex items-center md:order-2">
            <button type="button" class="flex mr-3 text-sm  md:mr-0 focus:ring-4 focus:ring-gray-300" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
              <img class="mb-3 w-9 h-9 rounded-full shadow-lg" src="image/admin.jpg" alt="admin">
    ...
    <div class="py-3 px-4mx-auto max-w-screen-xl md:px-6">
        <div class="flex items-center justify-between">
            <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                <li>
                    <a href="/" class="text-black hover:underline bg-yellow-600 font-medium rounded-full text-sm px-3 py-1 text-center" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="/produk" class="text-black hover:underline bg-yellow-600 font-medium rounded-full text-sm px-3 py-1 text-center">Produk</a>
                </li>
                <li>
                    <a href="/pesanan" class="text-black hover:underline bg-yellow-600 font-medium rounded-full text-sm px-3 py-1 text-center">Pesanan</a>
                </li>
                <li>
                    <a href="/tentang" class="text-black hover:underline bg-yellow-600 font-medium rounded-full text-sm px-3 py-1 text-center">Tentang</a>
                </li>
            </ul>      
            <ul class="flex flex-row mt-0 mr-2 space-x-4 text-sm font-medium">
                <a href="/cart" id="multiLevelDropdownButton" data-dropdown-toggle="dropdown" class="text-black  font-medium text-sm px-4 py-2.5 text-center inline-flex items-center" type="button">Keranjang<svg class="ml-2 w-8 h-8" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM9 5.5V7h1.5a.5.5 0 0 1 0 1H9v1.5a.5.5 0 0 1-1 0V8H6.5a.5.5 0 0 1 0-1H8V5.5a.5.5 0 0 1 1 0z"/></svg></a>
            </ul>
        </div>
    </div>
</nav>
