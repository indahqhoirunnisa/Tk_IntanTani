      ...
      <img class="absolute h-auto w-full object-cover"src="image/login.png"alt="my zomato"/>
        ...
        @csrf   
            ...
            <div class="flex w-full mt-8">
                ...
                <button class="w-full bg-[#c75733] text-white text-sm py-2 px-4 font-semibold rounded focus:outline-none focus:shadow-outline h-10" type="submit">{{ __('Register') }}</button>
              </div>
