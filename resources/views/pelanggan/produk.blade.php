    ...
    <div class="row-span-4 col-span-2">
        <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
            ...
            <div class="rounded overflow-hidden shadow-lg">
              <img class="w-96" src="image/benih/b1.jpg" alt="cabai">
              <div class="px-6 py-4">
            ...
            <!--Card 2-->
            <div class="rounded overflow-hidden shadow-lg">
              <img class="w-96" src="image/benih/b2.jpg" alt="semangka">
              <div class="px-6 py-4">
             ...
             <!--Card 3-->
             <div class="rounded overflow-hidden shadow-lg">
                <img class="w-96" src="image/herbisida/h1.jpg" alt="herbisida">
                <div class="px-6 py-4">
