        ...
        <div class="row w-100">
            ...
            <div class="col mt-5 w-50">
                <div class="mt-5 ml-5" style="width: 25rem;">
                    ...
                    {{-- <div><center><b>{{ __('LOGIN') }}</b></center></div> --}}
...
<div class="row w-100">
    <div class="col mt-5 w-50">
            ...
            <img class="max-w-md h-auto" src="image/admin.jpg" alt="image description">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="user_avatar">Upload file</label>
                    <input class="block w-42 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer  focus:outline-none dark:bg-gray-700 " aria-describedby="user_avatar_help" id="user_avatar" type="file">
